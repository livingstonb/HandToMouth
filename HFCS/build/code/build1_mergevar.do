cd ${basedir}/build/input/HFCS1_3
...
save ${basedir}/build/temp/cash.dta, replace

foreach k of numlist 2/5{
use HN`k', clear
keep id survey sa0010 sa0100 im0100 hnj3800 fhnj3800 hng0710 fhng0710
keep if sa0100 == "ES" | sa0100 == "IT"
append using ${basedir}/build/temp/cash.dta
save ${basedir}/build/temp/cash.dta, replace
}
///////////////////////////////////////////////////////////////////////////////
...
drop _merge
save ${basedir}/build/temp/HD`k', replace
}
///////////////////////////////////////////////////////////////////////////////
...
merge 1:1 id using ${basedir}/build/temp/HD`k'
drop _merge
save ${basedir}/build/temp/HDP`k', replace
}
